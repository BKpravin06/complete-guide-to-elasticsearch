...
__How to grant access to elastic__

**got the  docker-compose.yml file**
...
services:
  elasticsearch:
    ...
    environment:
      ...
      - ELASTIC_PASSWORD=StrongPass123   # initial password for 'elastic' superuser
    ports:
      - "9200:9200"
  ...
  kibana:
    ...
    ports:
      - "192.168.168.128:5601:5601"   # bind Kibana only to this host IP
